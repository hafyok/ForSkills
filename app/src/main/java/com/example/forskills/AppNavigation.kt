...
import com.example.forskills.Presentation.AirTicket.AirTicketViewModel
...
fun AppNavigation(modifier: Modifier = Modifier) {
    ...
    val viewModel = AirTicketViewModel()
    Scaffold(
        ...
        NavHost(navController = navController, startDestination = BottomNavItem.AirTickets.route, modifier = Modifier.padding(innerPadding)) {
            composable(BottomNavItem.AirTickets.route) { AirTicketsScreen(navController, viewModel) }
